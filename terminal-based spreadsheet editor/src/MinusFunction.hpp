...
/**
 * this class is wrapper of math function : minus. It helps to work with ast ( = abstract syntax tree).
...
public:
    ...
    std :: shared_ptr<BinaryFunction> clone() override { return std :: make_shared<MinusFunction>(*this); }
